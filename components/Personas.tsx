...
import { PenTool, GraduationCap, Code, Rocket } from 'lucide-react';

const Personas: React.FC = () => {
  const personas = [
    {
      role: 'Creators & Designers',
      desc: 'For unified visual and narrative creation.',
      icon: PenTool,
    },
    {
      role: 'Students & Learners',
      desc: 'For AI-aided learning and experimentation.',
      icon: GraduationCap,
    },
    {
      role: 'Developers & Engineers',
      desc: 'For fast, intelligent code assistance.',
      icon: Code,
    },
    {
      role: 'Startups & Small Teams',
      desc: 'For affordable, end-to-end creative power.',
      icon: Rocket,
    },
  ];
