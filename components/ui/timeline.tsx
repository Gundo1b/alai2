  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-slate-900 dark:text-white max-w-4xl font-display font-bold flex flex-wrap gap-2">
           <TextRoll className="inline-block">The Road to</TextRoll> 
           <span className="text-brand-primary inline-block">
             <TextRoll delay={0.5} className="inline-block">Unified Intelligence</TextRoll>
           </span>
        </h2>
